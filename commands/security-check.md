---
description: Red-team security audit - run before you commit
argument-hint: [file/feature path or blank for staged changes]
---
...
**If "$ARGUMENTS" is provided:** Focus on that specific file/feature
